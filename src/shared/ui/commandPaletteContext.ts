...
/**
 * Context for the ⌘K palette, kept in its own module so both the provider and
 * its consumers can import it without a component file exporting a
...
/** Opens the command palette from anywhere (e.g. the top bar's search field). */
