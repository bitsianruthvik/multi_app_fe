 ...
 * precision loss), so a value of 7850 arrives as `"7850.000000"`. Without this,
 * `String.prototype.toLocaleString()` silently returns the raw string and the
 * cell renders "7850.000000" instead of "7,850". Every numeric cell goes
 * through here — do not assume the API gave you a number.
 */
...
const Dash = () => (
  <Box component="span" sx={{ ...MONO, color: 'var(--c-text-3)' }}>
    —
  </Box>
);
 ...
 * `withTime` shows HH:MM. Bad or missing input renders an em dash rather than
